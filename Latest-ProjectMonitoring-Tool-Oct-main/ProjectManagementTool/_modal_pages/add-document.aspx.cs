...
namespace ProjectManager._modal_pages
{
    public partial class add_document : System.Web.UI.Page
    {
       ...
       // protected static bool processComplete = false;
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["fID"] != null)
                    {
                        ...
                        //
                        if (WebConfigurationManager.AppSettings["Domain"] == "ONTB" || WebConfigurationManager.AppSettings["Domain"] == "IPE Global")
                        {
                            if(FlowType == "STP")
                            {
        ...
        {
            if (WebConfigurationManager.AppSettings["Domain"] == "ONTB" || WebConfigurationManager.AppSettings["Domain"] == "IPE Global" || WebConfigurationManager.AppSettings["Domain"] == "Suez")
            {
                ...
                try
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (dsUser.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (WebConfigurationManager.AppSettings["Domain"] == "IPE Global")
                            {
